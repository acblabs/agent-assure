...
_V065_BUNDLED_SENSITIVITY_IDENTITIES: Final = BundledSensitivityIdentitySet(
    suite_identities=BUNDLED_SENSITIVITY_SUITE_IDENTITIES,
    knowledge_contract_digest=BUNDLED_SENSITIVITY_KNOWLEDGE_CONTRACT_DIGEST,
    corpus_snapshot_identities=BUNDLED_SENSITIVITY_CORPUS_SNAPSHOT_IDENTITIES,
)
