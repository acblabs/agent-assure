...
message: fixture-declared material claim has no paired reference and content-addressed evidence item link
```
...
release attestations, release SBOMs, or cosign verification material.
