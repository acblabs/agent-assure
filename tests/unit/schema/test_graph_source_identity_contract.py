...
def test_current_evaluation_summary_rejects_empty_graph_source_identity() -> None:
...
def test_current_evaluation_finding_rejects_empty_graph_source_identity() -> None:
    payload = {
